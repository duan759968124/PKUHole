 ...
 * @describe：Glide加载引擎
 */
public class GlideEngineNet implements ImageEngine {
    ...
    private GlideEngineNet() {
    }

    private static final class InstanceHolder {
        static final GlideEngineNet instance = new GlideEngineNet();
    }

    public static GlideEngineNet createGlideEngine() {
